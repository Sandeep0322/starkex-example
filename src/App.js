...
function App() {
  ...
  const getStarkSign = async () => {
    const msgHash = "d48540481cfe9cf19f362f6da55a8b43ada3bc89e5340afe1c0a792733186c"
    ...
    let r = await web3.utils.toHex(sign.r)
    let s = await web3.utils.toHex(sign.s)
    console.log(r, s)
    return sign
  }
  ...
  const transferToken = async () => {
    ...
    // console.log("starkex", starkExAPI.gateway)
  ...
  return (
    <div className="App">
      ...
      {account != "" && <Button className="button-85" onClick={getStarkSign}>starkSign</Button>}
    </div>
  );
}
